---
title: "Log Scale with Limits Scaled to Maximum Values"
output: html_document
---

- Charts are scaled from zero to a fixed upper limit for each indicator
- Values exceeding the upper limit are clipped at the upper range border
...
for (indi in indicators_12) {
  for (subpop in subpops_12) {
    ...
    p1 <- indicator_plot(indicators_2012, subpop, indi, measurements[indi][[1]], scale_max[indi][[1]])
    print(p1)
    cat("  \n")
    ...
    p2 <- indicator_plot(indicators_2017, subpop, indi, measurements[indi][[1]], scale_max[indi][[1]])
    print(p2)
    cat("  \n")
  }
}
