...
<!-- - In this scenario, if your chosen indicator is Secchi and your chosen state is Maine, the charts will be scaled to the maximum value for that indicator found in the Maine, Region 1, and All Sites subpopulations in 2012 or 2017. -->
...
region_9_subpop_abbrs <- c("AZ", "CA", "NV")
region_8_subpop_abbrs <- c("CO", "MT", "ND", "SD", "UT", "WY")
...
for (indi in c("CHL")) {
  ...
  i <- 1
  for (subpop in region_8_subpop_abbrs) {
